...
"C:\Program Files\7-Zip\7z.exe" a NumerousControllerInterface_Bve5.zip "Input Devices" LibUsbDotNet.dll Newtonsoft.Json.dll
cd ..\..\NumerousControllerInterface.NET4\bin\Release
if not exist "Input Devices" mkdir "Input Devices"
copy "Kusaanko.NumerousControllerInterface.NET4.dll" "Input Devices" /Y
"C:\Program Files\7-Zip\7z.exe" a NumerousControllerInterface_Bve6.zip "Input Devices" LibUsbDotNet.dll Newtonsoft.Json.dll
cd ..\..\..\..\
...
copy /Y "bin\NumerousControllerInterface_Bve5.zip" "bin\NumerousControllerInterface_Bve5.update.zip"
copy /Y "bin\NumerousControllerInterface_Bve6.zip" "bin\NumerousControllerInterface_Bve6.update.zip"
